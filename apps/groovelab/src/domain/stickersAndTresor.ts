...
export const ALL_STICKERS = [
  ...
  { id: 'schuljahr-14', emoji: '💫', title: 'Kosmischer Solist (14. Campus-Jahr)', desc: 'Jede Note schwingt im perfekten Puls – meisterhafte Virtuosität im intuitiven Fluss.', equiv: 'Vollendete Solistenklasse', color: '#84cc16', bg: 'rgba(132, 204, 22, 0.15)', auto: true, category: 'schuljahr', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  { id: 'schuljahr-15', emoji: '🏆', title: 'Kaiser der Meisterschaft (15. Campus-Jahr)', desc: 'Fünfzehn Jahre gelebte Hingabe auf Campus-Groovelab – ein Meilenstein für die Ewigkeit!', equiv: 'Unsterblicher Goldstandard', color: '#e11d48', bg: 'rgba(225, 29, 72, 0.18)', auto: true, category: 'schuljahr', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  ...
  // 🌍 World Tour: Kulturerbe & Nationalhymnen (Länder-Siegel)
  { id: 'wt-de', emoji: '🇩🇪', title: 'Einigkeit & Recht & Freiheit', desc: 'Die deutsche Nationalhymne (3. Strophe) im Aufgabenheft gemeistert!', equiv: 'Klassische Phrasierung & Haydns Melodiebogen souverän am Instrument gespielt.', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-fr', emoji: '🇫🇷', title: 'Marseillaise-Trommel', desc: 'La Marseillaise mit stolzem Rhythmus eingespielt!', equiv: 'Feurige Revolutions-Rhythmik & punktierte Viertelnoten im exakten Takt.', color: '#3b82f6', bg: 'rgba(59, 130, 246, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-gb', emoji: '🇬🇧', title: 'Royal Crown Anthem', desc: 'God Save the King im würdevollen 3/4-Takt absolviert!', equiv: 'Feierliches Dreivierteltakt-Gefühl und barocker Klangausdruck.', color: '#ef4444', bg: 'rgba(239, 68, 68, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-it', emoji: '🇮🇹', title: 'Verdi-Novaro-Lorbeer', desc: 'Fratelli d\'Italia mit bühnenreifem Elan gemeistert!', equiv: 'Spritziges Tempo, leichte Phrasierung und italienische Musizierfreude.', color: '#10b981', bg: 'rgba(16, 185, 129, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-at', emoji: '🇦🇹', title: 'Wiener Mozart-Siegel', desc: 'Österreichs Hymne im klassischen Choral-Bogen gespielt!', equiv: 'Wiener Klassik, weiche Kantilene und melodische Eleganz.', color: '#e11d48', bg: 'rgba(225, 29, 72, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-ch', emoji: '🇨🇭', title: 'Schweizerpsalm-Alpenhorn', desc: 'Den Schweizerpsalm mit klangvoller Ruhe zelebriert!', equiv: 'Tiefer Klang, getragenes Tempo und dynamische Balance.', color: '#dc2626', bg: 'rgba(220, 38, 38, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-nl', emoji: '🇳🇱', title: 'Wilhelmus-Renaissance-Siegel', desc: 'Die älteste Hymne der Welt historisch erobert!', equiv: 'Stolzer Renaissance-Schritt und klare Intervallführung.', color: '#f97316', bg: 'rgba(249, 115, 22, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-es', emoji: '🇪🇸', title: 'Marcha-Real-Krone', desc: 'Spaniens königlichen Instrumentalmarsch gemeistert!', equiv: 'Exaktes Marsch-Timing und punktierte Rhythmen ohne Textstütze.', color: '#eab308', bg: 'rgba(234, 179, 8, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-us', emoji: '🇺🇸', title: 'Star-Spangled Bell', desc: 'Die US-Hymne mit sicherem Oktavsprung bezwungen!', equiv: 'Souveräne Beherrschung weiter Intervalle und heroischer Klang.', color: '#2563eb', bg: 'rgba(37, 99, 235, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-ca', emoji: '🇨🇦', title: 'O-Canada-Ahorn-Siegel', desc: 'Kanadas Hymne mit warmem, aufstrebendem Ton gemeistert!', equiv: 'Melodische Steigerung und warmer Gesamtklang am Instrument.', color: '#be123c', bg: 'rgba(190, 18, 60, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-jp', emoji: '🇯🇵', title: 'Kimi-Ga-Yo Koto-Siegel', desc: 'Japans altehrwürdige Hofmusik meditativ intoniert!', equiv: 'Gagaku-Ruhe, feines Gehör und modale D-Dorisch-Harmonik.', color: '#e11d48', bg: 'rgba(225, 29, 72, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-au', emoji: '🇦🇺', title: 'Advance-Australia-Kompass', desc: 'Australiens Hymne im frischen Vorwärts-Groove gemeistert!', equiv: 'Stabiles 96-BPM-Timing und lebendige Rhythmusarbeit.', color: '#059669', bg: 'rgba(5, 150, 105, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },
  { id: 'wt-eu', emoji: '🇪🇺', title: 'Ode-an-die-Freude-Stern', desc: 'Beethovens Europahymne vollständig beherrscht!', equiv: 'Flüssiges Blattspiel, Tonschönheit und europäischer Gemeinschaftsklang.', color: '#0284c7', bg: 'rgba(2, 132, 199, 0.12)', auto: true, category: 'worldtour', rarity: 'rare', rarityLabel: 'Selten', multi: false },

  // 🌌 Holografische Kontinent-Wappen (Legendary / Special Edition)
  { id: 'wt-continent-europe', emoji: '🇪🇺', title: 'Europa-Harmonie-Wappen', desc: 'Alle europäischen Hymnen gemeistert – ein wahrer Meister des Kontinents!', equiv: 'Legendäre Repertoire-Tiefe und vollendete Beherrschung europäischer Klassik.', color: '#3b82f6', bg: 'rgba(59, 130, 246, 0.2)', auto: true, category: 'worldtour', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  { id: 'wt-continent-americas', emoji: '🌎', title: 'Pan-Amerika-Sonnenschild', desc: 'Alle amerikanischen Hymnen mit Bravour gespielt!', equiv: 'Stilistische Reife im weiten Tonumfang und transatlantischer Rhythmik.', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.2)', auto: true, category: 'worldtour', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  { id: 'wt-continent-asia', emoji: '🌏', title: 'Asien-Seidenstraßen-Gong', desc: 'Traditionelle asiatische Melodien meditativ und meisterhaft verinnerlicht!', equiv: 'Feinstes Gehör, Geduld und Beherrschung fernöstlicher Tonsysteme.', color: '#ec4899', bg: 'rgba(236, 72, 153, 0.2)', auto: true, category: 'worldtour', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  { id: 'wt-continent-oceania', emoji: '🦘', title: 'Ozeanien-Sternen-Kompass', desc: 'Hymnen der Südhalbkugel souverän ins Repertoire geholt!', equiv: 'Groovige Frische und unerschütterliches rhythmisches Fundament.', color: '#10b981', bg: 'rgba(16, 185, 129, 0.2)', auto: true, category: 'worldtour', rarity: 'legendary', rarityLabel: 'Legendär', multi: false },
  { id: 'wt-continent-africa', emoji: '🌍', title: 'Afrikas Wiege des Grooves', desc: 'Die rhythmischen Wurzeln und Melodien des Kontinents gemeistert!', equiv: 'Polyrhythmische Meisterschaft, Pulsgefühl und lebendige Musizierfreude.', color: '#8b5cf6', bg: 'rgba(139, 92, 246, 0.2)', auto: true, category: 'worldtour', rarity: 'legendary', rarityLabel: 'Legendär', multi: false }
];
...
export const getUnifiedStickerStatus = (
  ...
  if (sticker.category === 'ueben') {
    ...
    currentVal = effectiveMasteredSongsCount;
    targetVal = target;
    ...
    currentVal = isMilestoneUnlocked ? 1 : 0;
    targetVal = 1;
    ...
    targetVal = 1;
    currentVal = explicitAwardCount > 0 ? explicitAwardCount : 0;
  }
  ...
  const progressPercent = targetVal && targetVal > 0 
    ? Math.min(100, Math.round(((currentVal || 0) / targetVal) * 100))
    : (isUnlocked ? 100 : 0);
