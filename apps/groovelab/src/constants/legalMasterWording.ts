...
export const LEGAL_MASTER_WORDING = {
  ...
  legalDisclaimers: {
    ...
    b2bLiabilityCap: 'Dynamische B2B-Haftungshöchstgrenze (Liability Cap & Cyber-Koppelung): Die Haftung des Betreibers für einfache Fahrlässigkeit bei Verletzung wesentlicher Vertragspflichten (Kardinalpflichten) ist je Kalenderjahr auf die Summe der in den vorangegangenen 12 Monaten vom Kunden tatsächlich an den Betreiber gezahlten Netto-Vergütung (mindestens 2.500,00 € und maximal 10.000,00 € bzw. CHF 10.000,00) begrenzt. Soweit ein Schaden durch die vom Betreiber unterhaltene gewerbliche Cyber- und IT-Haftpflichtversicherung gedeckt ist, beschränkt sich die Haftung auf die tatsächlich erbrachte Versicherungsleistung (Deckungssumme 2.000.000,00 €). Die verschuldensunabhängige Garantiehaftung für anfängliche Mängel (§ 536a Abs. 1 Alt. 1 BGB / § 1096 ABGB / Art. 259a OR) ist vollumfänglich ausgeschlossen.',
    ...
    sla995: 'Service Level Agreement (SLA 99,5% Verfügbarkeit): Verbindliche Verfügbarkeitsgarantie im Jahresmittel mit 4-stufiger Störungsklassifizierung (P1–P4), garantierten Reaktionszeiten (< 2h für P1) und automatischem Service-Credit-Gutschriftenmodell bei Verfügbarkeitsunterschreitung.',
