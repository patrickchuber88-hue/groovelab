...
export const LEGAL_MASTER_WORDING = {
  ...
  legalDisclaimers: {
    ...
    dataBackupMitverschulden: 'Mitverschuldensklausel & Datenwiederherstellung (§ 254 BGB): Für den Verlust von Daten haftet der Betreiber der Höhe nach nur insoweit, als der Schaden auch bei ordnungsgemäßer und regelmäßiger Datensicherung durch den Kunden bzw. über die integrierte 1-Klick-Schaltfläche „Export“ für das didaktische Hausaufgaben- und Übe-Protokoll eingetreten wäre (beschränkt auf den typischen Wiederherstellungsaufwand aus regulären Server-Backups).',
    contractTermSchoolYear: 'Vertragslaufzeit & Kündigungsharmonisierung: Verträge für Bildungseinrichtungen laufen grundsätzlich synchron zum Schuljahr (12 Monate bis zum 31. August) und sind mit einer Frist von 3 Monaten zum Schuljahresende (31. Mai) kündbar (Verlängerung um jeweils 12 Monate). Das gesetzliche Recht zur außerordentlichen Kündigung aus wichtigem Grund (§ 314 BGB) bleibt unberührt.',
    ...
    standaloneAvvArt28: 'Behördentauglicher Stand-Alone Auftragsverarbeitungsvertrag (AVV gem. Art. 28 DSGVO & nDSG): Vollständiger Vertrag mit Anlage 1 (Datenarten & Betroffene) und Anlage 2 (Technische und organisatorische Maßnahmen gem. Art. 32 DSGVO) für Schulträger und Datenschutzbeauftragte. Vorfallsmeldung des Auftragnehmers bei schwerwiegenden Datenpannen (P1) binnen 24 Stunden (bei sonstigen Vorfällen binnen 48 Stunden) zur Wahrung der 72h-Meldepflicht nach Art. 33 DSGVO.',
