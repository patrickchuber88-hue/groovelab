                          ...
                          return (
                            <div
                              ...
                              style={{
                                ...
                                visibility: 'visible',
                                opacity: draggedStudentId === bs.id ? 0.55 : (selectedStudentId !== null ? 0.35 : 1),
                          ...
                          return (
                            <div
                              ...
                              style={{
                                ...
                                zIndex: 2,
                                visibility: 'visible',
                                opacity: draggedStudentId === bs.id ? 0.55 : 1,
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              justifyContent: 'center', gap: '2px',
                              zIndex: selectedStudentId !== null ? (isSelected ? 10 : 2) : (draggedStudentId === bs.id ? 10 : 2),
                              userSelect: 'none',
                              WebkitUserSelect: 'none',
                              WebkitTouchCallout: 'none',
                              touchAction: 'none',
                              visibility: 'visible',
                              opacity: draggedStudentId === bs.id ? 0.55 : ((selectedStudentId !== null || draggedStudentId !== null)
                                ? ((selectedStudentId === bs.id || draggedStudentId === bs.id) ? 1 : 0.22)
                                : 1),
                              filter: (selectedStudentId !== null && !isSelected && draggedStudentId !== bs.id) ? 'grayscale(35%)' : 'none',
                              pointerEvents: 'auto',
