  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        <h2 style={{ margin: 0, fontSize: '1.3rem', fontWeight: 900, color: '#10b981', letterSpacing: '-0.03em', textTransform: 'uppercase' }}>
          Groove-Loopstation
        </h2>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', margin: '6px 0' }}>
        <svg width="150" height="150" viewBox="0 0 100 100">
          ...
          <circle
            ...
            style={{ 
              ...
              filter: isPlaying ? 'drop-shadow(0 0 5px rgba(16, 185, 129, 0.5))' : 'none'
            }}
          />
        </svg>
        <div style={{ position: 'absolute', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <span style={{ fontSize: '0.58rem', color: '#10b981', fontWeight: 900, letterSpacing: '0.12em', marginTop: '4px' }}>
      ...
      <div style={{ display: 'flex', gap: '12px' }}>
        <button
          ...
          style={{
            ...
            gap: '8px',
            boxShadow: isPlaying ? '0 4px 15px rgba(239, 68, 68, 0.3)' : '0 4px 15px rgba(16, 185, 129, 0.25)',
            ...
            >
                ...
                {track.isRecording ? (
                  ...
                  <button
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      boxShadow: !hasAudio && (track.id === 1 || masterLoopDuration) ? '0 4px 10px rgba(16, 185, 129, 0.2)' : 'none',
                      transition: 'all 0.15s ease'
                    }}
                  >
                    <Mic size={16} />
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '5px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ 
                    fontSize: '0.55rem', 
                    color: track.isRecording ? '#ef4444' : track.isWaiting ? '#eab308' : hasAudio ? '#10b981' : '#475569', 
                    fontWeight: 800, 
                    textTransform: 'uppercase',
                    letterSpacing: '0.05em'
                  }}>
