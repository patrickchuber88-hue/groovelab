...
### 3. Kanonische Gebührenstruktur, Fair-Play-Entlastung, Laufzeit & Zahlungsbedingungen
...
(6) **Vertragslaufzeit & Kündigungsharmonisierung:** Verträge mit Bildungseinrichtungen laufen grundsätzlich synchron zum Schuljahr (12 Monate bis zum 31. August des jeweiligen Schuljahres) und verlängern sich jeweils um weitere zwölf (12) Monate, sofern sie nicht mit einer Frist von drei (3) Monaten zum Schuljahresende (31. Mai) in Textform gekündigt werden. Bei unterjährigem Vertragsbeginn läuft die Erstlaufzeit bis zum 31. August des Folgejahres (Rumpf-Schuljahr). Das gesetzliche Recht zur außerordentlichen Kündigung aus wichtigem Grund (§ 314 BGB) bleibt unberührt.
