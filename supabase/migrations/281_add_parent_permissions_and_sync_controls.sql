-- Migration 281: Add parent_permissions JSONB to users_raw and update public.users view
-- Ensures parental control settings, board overrides, bedtime modes and custom permissions synchronize seamlessly.
...
ALTER TABLE public.students ADD COLUMN IF NOT EXISTS parent_allow_chat BOOLEAN DEFAULT true;
ALTER TABLE public.students ADD COLUMN IF NOT EXISTS parent_allow_timer BOOLEAN DEFAULT true;
ALTER TABLE public.students ADD COLUMN IF NOT EXISTS parent_allow_leaderboard BOOLEAN DEFAULT true;
ALTER TABLE public.students ADD COLUMN IF NOT EXISTS parent_allow_groups BOOLEAN DEFAULT true;
ALTER TABLE public.students ADD COLUMN IF NOT EXISTS parent_allow_proposals BOOLEAN DEFAULT true;
...
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS parent_allow_chat BOOLEAN DEFAULT true;
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS parent_allow_timer BOOLEAN DEFAULT true;
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS parent_allow_leaderboard BOOLEAN DEFAULT true;
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS parent_allow_groups BOOLEAN DEFAULT true;
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS parent_allow_proposals BOOLEAN DEFAULT true;
...
-- 3. Recreate public.users view with all columns including parent_permissions
...
BEGIN
    ...
    IF TG_OP = 'UPDATE' THEN
        ...
        SET
            ...
            parent_permissions = COALESCE(NEW.parent_permissions, parent_permissions),
