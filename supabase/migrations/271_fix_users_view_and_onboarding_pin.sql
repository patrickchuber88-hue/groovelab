-- Migration 271: Fix users view, onboarding_pin column and DML trigger
-- Ensures public.users view includes onboarding_pin and handle_users_view_dml supports INSERT, UPDATE, DELETE seamlessly.

-- 1. Ensure onboarding_pin column exists on base tables
...
ALTER TABLE public.pending_students ADD COLUMN IF NOT EXISTS onboarding_pin TEXT;

-- 2. Drop existing trigger and view CASCADE
DROP TRIGGER IF EXISTS trg_users_view_dml ON public.users;
DROP VIEW IF EXISTS public.users CASCADE;

-- 3. Recreate public.users view with all columns including onboarding_pin
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        INSERT INTO public.users_raw (
            ...
            NEW.parent_allow_chat, NEW.parent_allow_timer, NEW.parent_allow_leaderboard, NEW.parent_allow_groups, NEW.parent_allow_proposals,
