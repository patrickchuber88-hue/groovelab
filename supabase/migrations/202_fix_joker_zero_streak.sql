-- Migration 202: Fix reset_expired_streaks function and reclaim joker for 0-streak users
...
-- Reclaim consumed jokers for all users whose current streak_flame is 0
