-- ==============================================================================
-- Migration 444: Fix trg_users_view_dml - Remove Non-Existent View Columns
-- OWASP ASVS Level 3 / Multi-Tenancy / Zero-Trust Invariants Preserved
-- ==============================================================================
...
COMMENT ON FUNCTION public.trg_users_view_dml() IS 'Tier-1 Enterprise+ INSTEAD OF trigger on public.users view ensuring strict multi-tenancy, BOLA prevention, role immutability, and zero field mismatches.';
