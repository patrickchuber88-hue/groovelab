-- Migration 198: Student onboarding is_groovelab_active set to FALSE by default.
-- Groovelab must be manually activated for each student by the school.
...
BEGIN
    ...
    VALUES (
        ...
        TRUE,
        TRUE,
        FALSE, -- is_groovelab_active = FALSE (was TRUE, now FALSE by default on onboarding)
        'active',
    ...
    ON CONFLICT (id) DO UPDATE SET
        ...
        is_groovelab_active = FALSE, -- is_groovelab_active = FALSE (was TRUE)
        status = 'active';
