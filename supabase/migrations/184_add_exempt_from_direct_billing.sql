...
ALTER TABLE public.users_raw ADD COLUMN IF NOT EXISTS exempt_from_direct_billing BOOLEAN DEFAULT false;

-- 2. Drop the old view and its trigger first to avoid dependency errors
...
-- 4. Recreate trigger function mapping
