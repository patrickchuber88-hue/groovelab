-- Migration 291: Add DACH Country Support to Music School Onboarding RPC
-- Supports Deutschland, Österreich, Schweiz with country-specific storage and billing localization.
...
BEGIN
    ...
    -- 4. Create school record directly in public.schools (Unbooked modules, 0 GB extra storage, 1 GB included base)
    ...
    -- 5. Create admin record directly in public.users_raw (Chalkboard hero image /campus_login_hero.png)
