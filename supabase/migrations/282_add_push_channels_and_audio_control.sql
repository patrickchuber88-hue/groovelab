-- Migration 282: Add granular push notification channels and audio recording parent controls
...
-- 3. Recreate public.users view with all columns including push channels and parent_allow_audio
...
BEGIN
    ...
    IF TG_OP = 'UPDATE' THEN
        ...
        SET
            ...
            push_notif_weekly_digest = COALESCE(NEW.push_notif_weekly_digest, push_notif_weekly_digest),
            push_notif_chat = COALESCE(NEW.push_notif_chat, push_notif_chat),
            push_notif_practice_reminder = COALESCE(NEW.push_notif_practice_reminder, push_notif_practice_reminder),
            ...
            parent_allow_audio = COALESCE(NEW.parent_allow_audio, parent_allow_audio),
