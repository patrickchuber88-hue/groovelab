-- Migration: Allow optional email address during student onboarding
-- This modifies complete_onboarding to skip email splitting and saving if the email is empty or NULL.
