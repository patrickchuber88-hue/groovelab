-- Migration: 209_block_teacher_modify_is_scheduled
-- Description: Re-introduces defaults and update blocks for the is_scheduled column on campus_event_program_points for teacher role.
