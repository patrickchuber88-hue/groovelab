...
for idx, char in enumerate(cleaned):
    ...
    if char == '(':
        ...
        if paren_stack:
            ...
            print("Extra closing parenthesis ')' at line", orig_line)
    elif char == '{':
        ...
        if brace_stack:
            ...
            print("Extra closing brace '}' at line", orig_line)

print("Remaining open parens:", [p[0] for p in paren_stack])
print("Remaining open braces:", [b[0] for b in brace_stack])
