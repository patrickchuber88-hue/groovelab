...
14 spezialisierte Suiten in `scripts/run_dashboard_forensics.ts`:
...
12. `test_audio_countin_playback_forensic.ts`: Audio-Vorzähler (4 Beats), Web Audio Autoplay-Integrität & unterbrechungsfreie Wiedergabe.
13. `test_audio_engine_lifecycle_forensic.ts`: Deep Audio & Media Hardware Lifecycle State-Machine Suite (8 Engines, Autoplay-Immunität, WebM Patcher, Cancellation Drills).
14. `test_interactive_journeys_forensic.ts`: Interaktive 4-Rollen Closed-Loop User-Journeys (Schüler, Lehrer, Sekretariat, Master-Admin).
...
| **Legal & Regulatory Compliance Guard**<br>`npm run legal:check` | `scripts/legal_compliance_guard.mjs` | **BFSG 2025**<br>**DIN EN 301 549 V3.2.1**<br>**ISO/IEC 27001 (A.8)**<br>**DSGVO (Art. 5, 8, 9, 15, 17, 28, 32)**<br>**BSG B 12 R 3/20 R**<br>**§ 7 SGB IV / § 266a StGB**<br>**BGB §§ 312j, 312k**<br>**UrhDaG § 1 Abs. 2**<br>**VO (EU) 2024/1689 (AI Act)** | • **14 Säulen & 24 Checks** Compliance-as-Code Guard (100% Code-Traversal)<br>• Anti-Scheinselbstständigkeits- & Weisungs-Wächter (Herrenberg-Schutz)<br>• 360° WAI-ARIA Modal Contracts & abmahnsichere Barrierefreiheitserklärung<br>• Zero-Photo Doktrin, Quiet-Hours ArbZG & Zero Sheet Music Upload Policy |
