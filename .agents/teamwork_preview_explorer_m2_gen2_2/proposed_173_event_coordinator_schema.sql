...
-- Description: Adds configuration columns to campus_events, creates campus_event_program_points, creates lessons table for testing/F1 compatibility, enables RLS, and sets up validation triggers.
...
DECLARE
    ...
    v_is_master boolean;
BEGIN
    -- Coalesce null values for NOT NULL columns with defaults to prevent PostgREST bulk insert failures
    ...
    IF TG_OP = 'INSERT' THEN
        ...
        IF v_role = 'teacher' THEN
            ...
            -- Force correct defaults for teacher submissions (no backdoor bypass)
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        ...
        IF v_role = 'teacher' THEN
            ...
            -- 3. Teachers cannot modify admin-only columns (no backdoor bypass)
    ...
    -- Modified to allow empty answers array ([]) as per T2_F8_3 (Verify empty responses are permitted)
